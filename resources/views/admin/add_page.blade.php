        ...
        <div class="col-lg-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form id="form" action="{{ route('admin.add_page.submit') }}" class="form-horizontal" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="page_content" rows="15" class="form-control" placeholder="Page display content write here" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
