        ...
        <div class="col-lg-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form id="form" action="{{ route('admin.add_vendor_category.submit') }}" class="form-horizontal" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Title <span class="required">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" name="vendor_category_name" id="vendor_category_name" class="form-control"  required/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="vendor_category_descriptions" rows="15" class="form-control" placeholder="content write here" ></textarea>
                            </div>
                        </div>
