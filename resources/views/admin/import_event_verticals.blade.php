        ...
        <div class="col-lg-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(array(
                        'url' => 'admin/import_event_verticals',
                        'method' => 'post',
                        'class' => 'form',  
                        'files' => true
                    )) }}
                        ...
                        <div class="form-group">
                         <div class="col-sm-4 col-sm-offset-2">
                            ...
                            <a href="{{ route('admin.event_verticals') }}" class="btn btn-default">cancel</a>
                        </div>
                        <div class="col-sm-6">
                            <a href="{{ url('public/uploads/sample/event_verticals.csv') }}"><i class="fa fa-download" aria-hidden="true"></i> Download sample csv </a>
                        </div>
                    </div>
